...
ipa: 
	xcodebuild clean build CODE_SIGNING_ALLOWED=NO ONLY_ACTIVE_ARCH=NO PRODUCT_BUNDLE_IDENTIFIER="com.xfxxx.kfd" -sdk iphoneos16.0 -scheme kfd -configuration Debug -derivedDataPath build

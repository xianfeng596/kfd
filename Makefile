...
ipa: 
	xcodebuild clean build CODE_SIGNING_ALLOWED=NO ONLY_ACTIVE_ARCH=NO PRODUCT_BUNDLE_IDENTIFIER="com.xfxx.kfd" -sdk iphoneos -scheme kfd -configuration Debug -derivedDataPath build -quiet
